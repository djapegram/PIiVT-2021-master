...
INSERT INTO `administrator` (`administrator_id`, `username`, `password_hash`, `created_at`) VALUES
	(1, 'pedja', '$2b$11$8ha1Z4VzpFo1bXBPjwjmEOnP0AAnxEq2zDPjJDgg4YbvvfHZfPWwe', '2021-07-21 20:30:41'),
	(2, 'tijana', 'adsjadsjadsjadsadsj', '2021-07-21 22:01:26'),
	(3, 'aleksandar', 'FD0F8BCCEACA95FF42FA62D2F909D693DD9F42ADA1D508108DE0004F9B96B8786A050BDAC4F5015954782F81F5873CA3B86B507BC876470E9EF2AD60FAD37763', '2021-07-22 18:32:16'),
	(7, 'andrea', '$2b$11$z6MeK6RB8mLis3jOuc913.MwsXWlQJuAsQcvmWv.JBQEAgVNzMtJW', '2021-08-09 21:24:54'),
	(9, 'jovan', '$2b$11$udn4odAcUGuOrULAePPO7eO4U.wgPG2PAO7KVLGGmC02xqrArTZke', '2021-08-19 21:57:50');
...
INSERT INTO `manufacturer` (`manufacturer_id`, `name`, `created_at`) VALUES
	(1, 'Plastiko', '2021-07-22 19:54:31'),
	(2, 'Plastic solution', '2021-07-22 19:54:43'),
	(3, 'Plastix', '2021-07-22 19:55:18');
...
INSERT INTO `order` (`order_id`, `cart_id`, `first_name`, `last_name`, `address`, `created_at`) VALUES
	(1, 1, 'Milan', 'Nikolic', 'Bulevar Oslobodjena 401', '2021-08-20 20:28:51'),
	(3, 2, 'Petar', 'Miric', 'Petrova 15', '2021-08-20 21:05:45'),
	(4, 5, 'Ivana', `Milivojevic`, 'Svetosavksa 17', '2021-08-21 16:05:55'),
	(5, 6, 'Ivan', 'Jaksic', 'Njegoseva 17a', '2021-08-21 16:08:04'),
	(6, 7, 'Stefan', 'Nemanjic', 'Skenderbegova 16', '2021-08-21 16:14:10');
...
INSERT INTO `user` (`user_id`, `username`, `password_hash`, `created_ad`, `email`) VALUES
	(1, 'Predrag Radojicic', 'djapegram', '$2b$11$FB0Hcsg530G.hlmJjuHLSuMS4fqSRdMnI5Y/Zq2EFWO9i/qBfUWre', '2021-07-22 19:58:15', 'predrag.radojicic.17@singimail.rs'),
	(2, 'Djordje', 'djolence', '2021-07-22 19:58:38', NULL),
	(4, 'Tijana Radojicic', 'ttijanaradojicic', '$2b$11$FB0Hcsg530G.hlmJjuHLSuMS4fqSRdMnI5Y/Zq2EFWO9i/qBfUWre', '2021-08-19 19:08:06', 'tijana.radojicic.17@singimail.rs'),
